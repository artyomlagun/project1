...
class StatisticsControllerTest < ActionController::TestCase
  ...
  test "should create statistic" do
    assert_difference('Statistic.count') do
      post :create, statistic: { date: @statistic.date, number: @statistic.number, project_id: @statistic.project_id, task_id: @statistic.task_id }
    end
  ...
  test "should update statistic" do
    patch :update, id: @statistic, statistic: { date: @statistic.date, number: @statistic.number, project_id: @statistic.project_id, task_id: @statistic.task_id }
    assert_redirected_to statistic_path(assigns(:statistic))
  end
